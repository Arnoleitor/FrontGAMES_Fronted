...
const Register = () => {
    ...
    return (
        ...
        <div class='designRegister'>
            ...
            <input id="relleno1" type='text' name='Apellido' title='Apellido'  lenght='30' placeholder='Apellido' />
            ...
            <input id="relleno1"type='text' name='address' title='address'  lenght='30' placeholder='Dirección' />
            ...
            <div className="botonSend" >Registrame</div>
            <div>{}</div>
